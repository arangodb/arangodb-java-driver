...
public final class IndexEntity {
    ...
    private Map<String, VectorIndexShardStatus> shards;
    ...
    public Map<String, VectorIndexShardStatus> getShards() {
        return shards;
    }
