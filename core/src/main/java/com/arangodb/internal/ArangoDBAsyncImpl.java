...
// */
//public class ArangoDBAsyncImpl extends InternalArangoDB implements ArangoDB {
//
//    private static final Logger LOGGER = LoggerFactory.getLogger(ArangoDBAsyncImpl.class);
//    private final HostHandler hostHandler;
//
//    public ArangoDBAsyncImpl(final ArangoConfig config,
...
//        hostResolver.init(this.executorSync(), getSerde());
