...
//    ArangoDatabaseAsync db();
     ...
     *
     * @param value A representation of a single document (POJO or {@link RawData}
     ...
     * _key is given, a new unique _key is generated automatically.
     *
     * @param values  A List of documents (POJO or {@link RawData})
     * @param options Additional options
     * @return information about the documents
     * @see <a href="https://www.arangodb.com/docs/stable/http/document-working-with-documents.html#create-document">API
     * Documentation</a>
     ...
     * @param type The type of the document (POJO or {@link RawData})
     ...
     * @param type The type of the documents (POJO or {@link RawData})
