...
public class ArangoDriverGraphVertexTest extends BaseGraphTest {
     ...
     * }
     * 
     * @Test public void test_get_vertex_graph_not_found() throws
     * ArangoException {
     * 
     ...
     * GraphEntity g1 = driver.createGraph("g1", "v1", "e1", null);
     * 
     * try { driver.createVertex("g2", new TestComplexEntity01("xxx", "yyy",
     * 10), null); fail(); } catch (ArangoException e) { assertThat(e.getCode(),
     ...
     * ArangoException {
     * 
     * try { DeletedEntity deleted = driver.deleteVertex("g2", "key", true,
     * null, null); fail(); } catch (ArangoException e) {
     * assertThat(e.getCode(), is(404)); assertThat(e.getErrorNumber(),
     * is(1901)); assertThat(e.getErrorMessage(), startsWith("no graph named"));
     * }
     * 
     * }
     * 
     ...
     * null);
     * 
     * try { DeletedEntity deleted = driver.deleteVertex("g1", "key", true,
     * null, null); fail(); } catch (ArangoException e) {
     * assertThat(e.getCode(), is(404)); assertThat(e.getErrorNumber(),
     * is(1903)); assertThat(e.getErrorMessage(),
     * startsWith("no vertex found for")); }
     * 
     * }
     * 
     ...
     * is(1903)); assertThat(e.getErrorMessage(), is("wrong revision")); }
     * 
     * }
     * 
     ...
     * 
     * // delete try { driver.deleteVertex("g1", v1.getDocumentKey(), null,
     * null, v1.getDocumentRevision() + 1); } catch (ArangoException e) {
     * assertThat(e.getCode(), is(412)); assertThat(e.getErrorNumber(),
     * is(1903)); assertThat(e.getErrorMessage(), is("wrong revision")); }
     * 
     * }
     ...
     * 
     * assertThat(updatedVertex.getDocumentHandle(),
     * is(v1.getDocumentHandle()));
