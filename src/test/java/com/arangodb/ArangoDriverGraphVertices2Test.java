...
public class ArangoDriverGraphVertices2Test extends BaseGraphTest {
  ...
  // TestComplexEntity02(1 ,10, 100), null);
  // DocumentEntity<TestComplexEntity01> v2 = driver.createVertex("g1", new
  // TestComplexEntity02(2 ,20, 100), null);
  // DocumentEntity<TestComplexEntity01> v3 = driver.createVertex("g1", new
  // TestComplexEntity02(3 ,30, 100), null);
  // DocumentEntity<TestComplexEntity01> v4 = driver.createVertex("g1", new
  // TestComplexEntity02(4 ,40, 200), null);
  // DocumentEntity<TestComplexEntity01> v5 = driver.createVertex("g1", new
  // TestComplexEntity02(5 ,50, 200), null);
  // DocumentEntity<TestComplexEntity01> v6 = driver.createVertex("g1", new
  // TestComplexEntity02(6 ,60, 400), null);
  // DocumentEntity<TestComplexEntity01> v7 = driver.createVertex("g1", new
  // TestComplexEntity02(7 ,70, 400), null);
  //
  // EdgeEntity<TestComplexEntity01> e1 = driver.createEdge("g1", "e1",
  // v1.getDocumentKey(), v2.getDocumentKey(), new TestComplexEntity02(1000,
  // 10000, 10000), "e1", null);
  // EdgeEntity<TestComplexEntity01> e2 = driver.createEdge("g1", "e2",
  // v2.getDocumentKey(), v3.getDocumentKey(), new TestComplexEntity02(2000,
  // 20000, 10000), "e2", null);
  // EdgeEntity<TestComplexEntity01> e3 = driver.createEdge("g1", "e3",
  // v5.getDocumentKey(), v2.getDocumentKey(), new TestComplexEntity02(3000,
  // 30000, 10000), "e3", null);
  // EdgeEntity<TestComplexEntity01> e4 = driver.createEdge("g1", "e4",
  // v2.getDocumentKey(), v6.getDocumentKey(), new TestComplexEntity02(4000,
  // 40000, 20000), "e4", null);
  // EdgeEntity<TestComplexEntity01> e5 = driver.createEdge("g1", "e5",
  // v7.getDocumentKey(), v2.getDocumentKey(), new TestComplexEntity02(5000,
  // 50000, 20000), "e5", null);
  // EdgeEntity<TestComplexEntity01> e6 = driver.createEdge("g1", "e6",
  // v3.getDocumentKey(), v4.getDocumentKey(), new TestComplexEntity02(6000,
  // 60000, 40000), "e6", null);
  // EdgeEntity<TestComplexEntity01> e7 = driver.createEdge("g1", "e7",
  // v6.getDocumentKey(), v7.getDocumentKey(), new TestComplexEntity02(7000,
  // 70000, 40000), "e7", null);
  //
  ...
  // CursorEntity<DocumentEntity<TestComplexEntity01>> cursor =
  // driver.getVertices(
