...
public class ArangoDriverGraphTest extends BaseGraphTest {
	...
	public void test_getGraphList() throws ArangoException {
		...
		final String graphName1 = "UnitTestGraph1";
		final String graphName2 = "UnitTestGraph2";
		final String graphName3 = "UnitTestGraph3";
	...
	public void test_createGraph_2() throws ArangoException {
		...
		final List<EdgeDefinitionEntity> edgeDefinitions = this.createEdgeDefinitions(2, 0);

		final List<String> orphanCollections = this.createOrphanCollections(2);
	...
	public void test_getGraph() throws ArangoException {
		...
		final GraphEntity graph = driver.getGraph(this.graphName);
		assertThat(graph.getEdgeDefinitionsEntity().getEdgeDefinitions().get(0).getClass().getName(),
			is(EdgeDefinitionEntity.class.getName()));
		...
		assertThat(graph.getEdgeDefinitionsEntity().getEdgeDefinitions().get(0).getCollection().startsWith("edge"),
			is(true));
	...
	public void test_getVertexCollections() throws ArangoException {
		driver.createGraph(this.graphName, this.createEdgeDefinitions(2, 0), this.createOrphanCollections(2), true);
		final List<String> collections = driver.graphGetVertexCollections(this.graphName);
	...
	public void test_createVertexCollection() throws ArangoException {
		driver.createGraph(this.graphName, this.createEdgeDefinitions(2, 0), this.createOrphanCollections(2), true);
		final GraphEntity graph = driver.graphCreateVertexCollection(this.graphName, collectionName);
	...
	public void test_get_edge_Collections() throws ArangoException {
		driver.createGraph(this.graphName, this.createEdgeDefinitions(2, 0), this.createOrphanCollections(2), true);
		final List<String> collections = driver.graphGetEdgeCollections(this.graphName);
	...
	public void test_create_edge_definition() throws ArangoException {
		final String edgeCollectionName = "UnitTestEdgeCollection";
		final String fromCollectionName = "UnitTestFromCollection";
		final String toCollectionName = "UnitTestToCollection";
		driver.createGraph(this.graphName, this.createEdgeDefinitions(2, 0), this.createOrphanCollections(2), true);
	...
	public void test_replace_edge_definition() throws ArangoException {
		final String edgeCollectionName = "UnitTestEdgeCollection";
		final String fromCollectionName1 = "UnitTestFromCollection1";
		final String fromCollectionName2 = "UnitTestFromCollection2";
		final String toCollectionName1 = "UnitTestToCollection1";
		final String toCollectionName2 = "UnitTestToCollection2";
		driver.createGraph(this.graphName, this.createEdgeDefinitions(2, 0), this.createOrphanCollections(2), true);
		final EdgeDefinitionEntity edgeDefinition1 = new EdgeDefinitionEntity();
		edgeDefinition1.setCollection(edgeCollectionName);
		final List<String> from1 = new ArrayList<String>();
		from1.add(fromCollectionName1);
		edgeDefinition1.setFrom(from1);
		final List<String> to1 = new ArrayList<String>();
		...
		final EdgeDefinitionEntity edgeDefinition2 = new EdgeDefinitionEntity();
		edgeDefinition2.setCollection(edgeCollectionName);
		final List<String> from2 = new ArrayList<String>();
		from2.add(fromCollectionName2);
		edgeDefinition2.setFrom(from2);
		final List<String> to2 = new ArrayList<String>();
		to2.add(toCollectionName2);
		edgeDefinition2.setTo(to2);
		final GraphEntity graph = driver.graphReplaceEdgeDefinition(this.graphName, edgeCollectionName,
			edgeDefinition2);
		final List<EdgeDefinitionEntity> edgeDefinitions = graph.getEdgeDefinitionsEntity().getEdgeDefinitions();
		for (final EdgeDefinitionEntity edgeDef : edgeDefinitions) {
			final List<String> f = edgeDef.getFrom();
			assertThat(f.contains(from1), is(false));
			final List<String> t = edgeDef.getTo();
	...
	public void test_replace_edge_definition_2_graphs() throws ArangoException {
		...
		to2.add(toCollectionName2);
		edgeDefinition2.setTo(to2);
		final GraphEntity graph1 = driver.graphReplaceEdgeDefinition(graphName1, edgeCollectionName, edgeDefinition2);
		final List<EdgeDefinitionEntity> edgeDefinitions1 = graph1.getEdgeDefinitionsEntity().getEdgeDefinitions();
		for (final EdgeDefinitionEntity edgeDef : edgeDefinitions1) {
			final List<String> f = edgeDef.getFrom();
			assertThat(f.contains(from1), is(false));
			final List<String> t = edgeDef.getTo();
			assertThat(t.contains(to1), is(false));
		}
		final GraphEntity graph2 = driver.graphReplaceEdgeDefinition(graphName1, edgeCollectionName, edgeDefinition2);
		final List<EdgeDefinitionEntity> edgeDefinitions2 = graph2.getEdgeDefinitionsEntity().getEdgeDefinitions();
		for (final EdgeDefinitionEntity edgeDef : edgeDefinitions2) {
			final List<String> f = edgeDef.getFrom();
			assertThat(f.contains(from1), is(false));
			final List<String> t = edgeDef.getTo();
			assertThat(t.contains(to1), is(false));
