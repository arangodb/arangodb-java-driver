...
public class ArangoDriverGraphEdgeUpdateTest extends BaseGraphTest {
  ...
  public void test_graphUpdateEdge() throws ArangoException {
    ...
    EdgeEntity<TestComplexEntity01> updatedEdge = driver.graphUpdateEdge(
      this.graphName,
      this.edgeCollectionName,
      edge.getDocumentKey(),
    ...
    updatedEdge = driver.graphGetEdge(
      this.graphName,
      this.edgeCollectionName,
      updatedEdge.getDocumentKey(),
  ...
  public void test_updateEdge_null() throws ArangoException {
    ...
    EdgeEntity<?> updatedEdge = driver.graphUpdateEdge(
      this.graphName,
      this.edgeCollectionName,
      edge.getDocumentKey(),
      null,
  ...
  public void test_updateEdge_match_ne() throws ArangoException {
    ...
    try {
      Long rev = edge.getDocumentRevision() + 1;
      driver.graphUpdateEdge(this.graphName, this.edgeCollectionName, edge.getDocumentKey(), new TestComplexEntity01(
          "xx", "yy", 20), null, null, null, rev);
      fail();
    } catch (ArangoException e) {
      assertThat(e.getCode(), is(412));
      assertThat(e.getErrorNumber(), is(1903));
