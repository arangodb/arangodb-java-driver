...
public class ArangoDriverGraphVertexReplaceTest extends BaseGraphTest {
  ...
  public void test_vertex_replace() throws ArangoException {
    ...
    // check exists vertex
    DocumentEntity<TestComplexEntity01> vertex = driver.getVertex(
      "g1",
      v1.getDocumentKey(),
  ...
  public void test_vertex_replace_graph_not_found() throws ArangoException {
    ...
    try {
      DocumentEntity<TestComplexEntity02> updatedVertex = driver.replaceVertex("g1", "key1", new TestComplexEntity02(1,
          2, 3));
      fail();
