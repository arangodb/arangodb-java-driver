...
import at.orz.arangodb.entity.BatchResponseEntity;
...
import at.orz.arangodb.impl.InternalBatchDriverImpl;
...
public class ArangoDriver extends BaseArangoDriver {
    ...
    public <T> T getBatchResponseByRequestId(String requestId) throws ArangoException {
        ...
        try {
            ...
            batchResponseEntity.getInvocationObject().getArangoDriver().getHttpManager()
                    .setPreDefinedResponse(batchResponseEntity.getHttpResponseEntity());
    ...
    public CollectionEntity createCollection(
        ...
        Boolean isSystem,
        Boolean isVolatile,
        CollectionType type) throws ArangoException {
    ...
    // public <T> DocumentEntity<T> getDocument(long collectionId, long
    // documentId, Class<?> clazz, Long ifNoneMatchRevision, Long
    // ifMatchRevision) throws ArangoException {
    // return getDocument(createDocumentHandle(collectionId, documentId), clazz,
    // ifNoneMatchRevision, ifMatchRevision);
    // }
    // public <T> DocumentEntity<T> getDocument(String collectionName, long
    // documentId, Class<?> clazz, Long ifNoneMatchRevision, Long
    // ifMatchRevision) throws ArangoException {
    // return getDocument(createDocumentHandle(collectionName, documentId),
    ...
    // ) throws ArangoException {
    // return kvsDriver.createKeyValue(getDefaultDatabase(), collectionName,
    // key, value, attributes, expiredDate);
    // }
    //
    ...
    // boolean create
    // ) throws ArangoException {
    // return kvsDriver.updateKeyValue(getDefaultDatabase(), collectionName,
    // key, value, attributes, expiredDate, create);
    // }
    //
    ...
    // public IndexEntity deleteIndexByFields(long collectionId, String...
    // fields) throws ArangoException {
    // }
    // public IndexEntity deleteIndexByFields(String collectionName, String...
    // fields) throws ArangoException {
    //
    // }
    ...
    // return createEdge(String.valueOf(collectionId), fromHandle, toHandle,
    // attribute);
    // }
    //
    // public <T> EdgeEntity<T> createEdge(
    ...
    // T attribute) throws ArangoException {
    //
    // return edgeDriver.createEdge(getDefaultDatabase(), collectionName,
    // fromHandle, toHandle, attribute);
    // }
    //
    // // TODO UpdateEdge
    ...
    // String fromHandle, String toHandle,
    // T attribute) throws ArangoException {
    // return edgeDriver.updateEdge(getDefaultDatabase(), collectionName,
    // fromHandle, toHandle, attribute);
    // }
    //
    ...
    // * @throws ArangoException
    // */
    // public <T> EdgeEntity<T> getEdge(String edgeHandle, Class<T>
    // attributeClass) throws ArangoException {
    // return edgeDriver.getEdge(getDefaultDatabase(), edgeHandle,
    // attributeClass);
    // }
    //
    // public EdgeEntity<?> deleteEdge(long collectionId, String edgeHandle)
    // throws ArangoException {
    // return deleteEdge(String.valueOf(collectionId), edgeHandle);
    // }
    // public EdgeEntity<?> deleteEdge(String collectionName, String edgeHandle)
    // throws ArangoException {
    // return edgeDriver.deleteEdge(getDefaultDatabase(), collectionName,
    // edgeHandle);
    // }
    //
    // public <T> EdgesEntity<T> getEdges(String collectionName, String
    // vertexHandle, Direction direction, Class<T> edgeAttributeClass) throws
    // ArangoException {
    // return edgeDriver.getEdges(getDefaultDatabase(), collectionName,
    // vertexHandle, direction, edgeAttributeClass);
    // }
    ...
    public DeletedEntity
            deleteVertex(String graphName, String key, Boolean waitForSync, Long rev, Long ifMatchRevision)
                    throws ArangoException {
