...
public class TraversalOptions {
    ...
    /**
     * @param sort JavaScript code of a custom comparison function for the edges. The signature of this function is (l,
    ...
    /**
     * @param minDepth ANDed with any existing filters): visits only nodes in at least the given depth
     * @return options
     */
    ...
    /**
     * @param startVertex The id of the startVertex, e.g. "users/foo".
     * @return options
     */
    ...
    /**
     * @param visitor JavaScript code of custom visitor function function signature: (config, result, vertex, path,
    ...
    /**
     * @param itemOrder The item iteration order can be "forward" or "backward"
     * @return options
     */
    ...
    /**
     * @param strategy The traversal strategy can be "depthfirst" or "breadthfirst"
     * @return options
     */
    ...
    /**
     * @param filter default is to include all nodes: body (JavaScript code) of custom filter function function signature:
    ...
    /**
     * @param init JavaScript code of custom result initialization function function signature: (config, result) -> void
    ...
    /**
     * @param maxIterations Maximum number of iterations in each traversal. This number can be set to prevent endless loops in
    ...
    /**
     * @param vertices Specifies uniqueness for vertices can be "none", "global" or "path"
     * @return options
     */
    ...
    /**
     * @param edges Specifies uniqueness for edges can be "none", "global" or "path"
     * @return options
     */
    ...
    /**
     * @param order The traversal order can be "preorder", "postorder" or "preorder-expander"
     * @return options
     */
    ...
    /**
     * @param graphName The name of the graph that contains the edges. Either edgeCollection or graphName has to be given. In
    ...
    /**
     * @param expander JavaScript code of custom expander function must be set if direction attribute is not set function
    ...
    /**
     * @param edgeCollection The name of the collection that contains the edges.
     * @return options
     */
