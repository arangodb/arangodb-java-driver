 ...
 * @author a-brandt
 */
public class ShortestPathResultEntity<V, E> extends BaseEntity {

	/**
	 * List of vertices.
	 */
	private VertexEntity<V> vertex;
	...
	public VertexEntity<V> getVertex() {
		return vertex;
	}

	public void setVertex(VertexEntity<V> vertex) {
		this.vertex = vertex;
	}
