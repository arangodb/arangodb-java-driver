...
public class ErrorNums {
	...
	public static final int ERROR_QUERY_LIST_EXPECTED = 1563;
	...
	public static final int ERROR_ARANGO_INDEX_BITARRAY_UPDATE_ATTRIBUTE_MISSING = 3402;
	public static final int ERROR_ARANGO_INDEX_BITARRAY_REMOVE_ITEM_MISSING = 3411;
	public static final int ERROR_ARANGO_INDEX_BITARRAY_INSERT_ITEM_UNSUPPORTED_VALUE = 3413;
	public static final int ERROR_ARANGO_INDEX_BITARRAY_CREATION_FAILURE_DUPLICATE_ATTRIBUTES = 3415;
	public static final int ERROR_ARANGO_INDEX_BITARRAY_CREATION_FAILURE_DUPLICATE_VALUES = 3417;
	public static final int RESULT_KEY_EXISTS = 10000;
	public static final int RESULT_ELEMENT_EXISTS = 10001;
	public static final int RESULT_KEY_NOT_FOUND = 10002;
	public static final int RESULT_ELEMENT_NOT_FOUND = 10003;
