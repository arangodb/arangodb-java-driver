 ...
 *
 */
public class InternalArangoEdgeCollection<E extends ArangoExecutor<R, C>, R, C extends Connection>
	...
	public InternalArangoEdgeCollection(final E executor, final String db, final String graph, final String name) {
		super(executor);
		this.db = db;
		this.graph = graph;
		this.name = name;
