...
class AQLActorsAndMoviesExampleTest {
     ...
     */
    @Test
    void allActorsActsInMovie1or2UnionDistinct() {
        final ArangoCursor<String> cursor = db.query(
     ...
     */
    @Test
    void allActorsActsInMovie1and2() {
        final ArangoCursor<String> cursor = db.query(
     ...
     */
    @Test
    void allMoviesBetweenActor1andActor2() {
        final ArangoCursor<String> cursor = db.query(
    ...
    void theNumberOfMoviesByActor() {
        ...
        assertThat(cursor.asListRemaining())
                .contains(new Actor("actors/Al", 1), new Actor("actors/AnnabellaS", 1), new Actor("actors/AnthonyE", 1),
                        ...
                        new Actor("actors/Charlize", 1), new Actor("actors/ChristopherG", 1), new Actor("actors" +
                                "/CoreyF", 1),
                        ...
                        new Actor("actors/KieferS", 2), new Actor("actors/Laurence", 3), new Actor("actors/MarshallB"
                                , 1),
