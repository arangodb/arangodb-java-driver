...
class ArangoDBTest {
    ...
    private boolean isAtLeastVersion(final int major, final int minor) {
        return TestUtils.isAtLeastVersion(arangoDBSync.getVersion().getVersion(), major, minor, 0);
    }

    private boolean isLessThanVersion(final int major, final int minor) {
        return TestUtils.isLessThanVersion(arangoDBSync.getVersion().getVersion(), major, minor, 0);
    }
